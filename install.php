...
(24, 'United States Dollar', 'USD', '$', '0'),
(25, 'Vi&#7879;t Nam &#272;&#7891;ng', 'VND', '&#8363;', '1');
...
(1, 'en_us', 'English', 'flags/en_us.png', 'LTR', '0', '1'),
...
(14, 'vi_vn', 'Ti&#7871;ng Vi&#7879;t', 'flags/vi_vn.png', 'LTR', '1', '1');
...
<html lang="en">
    <head>
        ...
        <title><?php echo SYS_NAME ?> &rsaquo; Trình cài đặt (v<?php echo SYS_VER ?>)</title>
                ...
                <form id="wizard" method="post" class="position-relative">
                    ...
                    <h3>
                        <div class="media">
                            ...
                            <div class="media-body">
                                <div class="bd-wizard-step-title">Giấy Phép</div>
                                <div class="bd-wizard-step-subtitle">Bước 1</div>
                            </div>
                        </div>
                    </h3>
                    <section>
                        <div class="content-wrapper">
                            <h3 class="section-heading">Chào mừng!</h3>
                            <p>
                                Chào mừng bạn đến trình cài đặt <strong>Quốc Minh (v<?php echo SYS_VER ?>)</strong>. Điền đầy đủ thông tin bên dưới để hoàn tất cài đặt.
								<a href="https://nguyenquocminh.com/" target="_blank">Hỗ trợ</a>
                            </p>
                            <h6 class="mt-4">
                                <strong>THỎA THUẬN CẤP PHÉP:</strong>
                            </h6>
                            <div>
                                <strong>Bạn CÓ THỂ:</strong>
                                <ol>
                                    <li>Cài đặt trên một sản phẩm tên miền (domain.com, sub.domain.com hoặc domain.com/thư mục).
                                    </li>
                                    <li>Cài đặt trên máy chủ localhost cho thử nghiệm hoặc phát triển.</li>
                                    <li>Chỉnh sửa mã nguồn và thiết kế như bạn muốn để phù hợp với nhu cầu kinh doanh của bạn.</li>
                                </ol>
                            </div>
                            <div>
                                <strong>Bạn KHÔNG THỂ:</strong>
                                <ol>
                                    <li>Cài đặt trên hai sản phẩm hoặc nhiều sản phẩm cùng một lúc với cùng một giấy phép.</li>
                                    <li>Bán lại, phân phối, cho đi hoặc trao đổi bằng bất kỳ hình thức nào cho bất kỳ bên thứ ba hoặc cá nhân nào.</li>
                                </ol>
                            </div>
                            <div class="form-check mt-5">
                                <input type="checkbox" class="form-check-input" id="license-checkbox">
                                <label class="form-check-label" for="license-checkbox">Tôi đồng ý với điều khoản và
                                điều kiện được đưa ra.</label>
                    ...
                    <h3>
                        <div class="media">
                            ...
                            <div class="media-body">
                                <div class="bd-wizard-step-title">Yêu Cầu</div>
                                <div class="bd-wizard-step-subtitle">Bước 2</div>
                            </div>
                        </div>
                    </h3>
                    <section>
                        <div class="content-wrapper">
                            ...
                            <div id="requirements_alert" class="alert alert-danger" style="display: none;">
                                <strong>Xin lỗi!</strong> Bạn cần kiểm tra các yêu cầu hệ thống để tiếp tục, hãy quay lại
                                hỗ trợ hosting để được giúp đỡ.
                            </div>
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>PHP 5.5+</td>
                                        <td>Yêu cầu phiên bản PHP 5.5 hoặc cao hơn</td>
                                        <td>
                                            <?php if($requirements_errors['PHP']) { ?>
                                            <font color="red"><i class="fas fa-times-circle"></i> Chưa được cài đặt</font>
                                            <?php } else { ?>
                                            <font color="green"><i class="fas fa-check-circle"></i> Đã cài đặt</font>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>MySQLi</td>
                                        <td>Yêu cầu tiện ích mở rộng MySQLi PHP</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>cURL</td>
                                        <td>Yêu cầu tiện ích mở rộng cURL PHP</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Mbstring</td>
                                        <td>Yêu cầu tiện ích mở rộng Mbstring cho UTF-8</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>GD Library</td>
                                        <td>Yêu cầu GD Library để xử lý hình ảnh</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>ZIP</td>
                                        <td>Yêu cầu tiện ích mở rộng ZIP để lấy tập tin sao lưu</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>.htaccess</td>
                                        <td>Yêu cầu tập tin .htaccess cho liên kết <small><strong>(Trong thư mục /Script)</strong></small>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>config.php</td>
                                        <td>Yêu cầu <strong>bao gồm tập tin</strong> có thể ghi được để cài đặt</td>
                                        <td>
                    ...
                    <h3>
                        <div class="media">
                            ...
                            <div class="media-body">
                                <div class="bd-wizard-step-title">Cài Đặt</div>
                                <div class="bd-wizard-step-subtitle">Bước 3</div>
                            </div>
                        </div>
                    </h3>
                    <section>
                        <div class="content-wrapper">
                            <h4 class="section-heading">Thông Tin Giấy Phép</h4>
                            <div class="row">
                                <div class="form-group col-12">
                                    <label for="purchase_code">Mã Mua Hàng Của Bạn</label>
                                    <input type="text" name="purchase_code" id="purchase_code" class="form-control" value="FREE_TCSN" placeholder="FREE_TCSN">
                                    <div class="invalid-feedback">
                                        Thông tin không được trống
                                    </div>
                                </div>
                            </div>
                            <h4 class="section-heading mt-4">Thông Tin Database</h4>
                            <div class="row">
                                <div class="form-group col-12">
                                    <label for="db_name">Tên Database</label>
                                    <input type="text" name="db_name" id="db_name" class="form-control" placeholder="tcsn">
                                    <div class="invalid-feedback">
                                        Thông tin không được trống
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="db_username" id="db_username" class="form-control" placeholder="username">
                                    <div class="invalid-feedback">
                                        Thông tin không được trống
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="db_password" id="db_password" class="form-control" placeholder="password">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="db_host">Database Host</label>
                                    <input type="text" name="db_host" id="db_host" class="form-control" value="localhost" placeholder="localhost">
                                    <div class="invalid-feedback">
                                        Thông tin không được trống
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="db_port" id="db_port" class="form-control" value="3306" placeholder="3306">
                                    <div class="invalid-feedback">
                                        Thông tin không được trống
                                    </div>
                                </div>
                            </div>
                            <h4 class="section-heading mt-4">Thông Tin Quản Trị Viên</h4>
                            <div class="row">
                                <div class="form-group col-12">
                                    <label for="admin_email">Email Quản Trị Viên</label>
                                    <input type="text" name="admin_email" id="admin_email" class="form-control" placeholder="admin@domain.com">
                                    <div class="invalid-feedback">
                                        Thông tin không được trống
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="admin_username">Tên Đăng Nhập Quản Trị Viên</label>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="admin_password">Mật Khẩu Quản Trị Viên</label>
                                    <input type="text" name="admin_password" id="admin_password" class="form-control" placeholder="password">
                                    <div class="invalid-feedback">
                                        Thông tin không được trống
                                    </div>
                                </div>
                    ...
                    <h3>
                        <div class="media">
                            ...
                            <div class="media-body">
                                <div class="bd-wizard-step-title">Hoàn Tất</div>
                                <div class="bd-wizard-step-subtitle">Bước 4</div>
                            </div>
                        </div>
                    </h3>
                    <section>
                        <div class="content-wrapper">
                            <h4 class="section-heading mb-5">Xem lại thông tin của bạn</h4>
                            <h6 class="font-weight-bold">Thông tin giấy phép</h6>
                            <p class="mb-4">
                                <strong>Mã mua hàng (<a target="_blank" href="https://tcsocialnetwork.tk">FREE TCSN</a>):</strong> <span id="entered_purchase_code"></span>
                            </p>
                            <h6 class="font-weight-bold">Thông Tin Database</h6>
                            <p class="mb-4">
                                <strong>Tên Database:</strong> <span id="entered_db_name"></span> <br>
                                <strong>Username:</strong> <span id="entered_db_username"></span> <br>
                                <strong>Mật khẩu:</strong> <span id="entered_db_password"></span> <br>
                                <strong>Host:</strong> <span id="entered_db_host"></span> <br>
                                <strong>Port:</strong> <span id="entered_db_port"></span>
                            </p>
                            <h6 class="font-weight-bold">Thông Tin Quản Trị Viên</h6>
                            <p class="mb-4">
                                <strong>Email:</strong> <span id="entered_admin_email"></span> <br>
                                <strong>Tên đăng nhập:</strong> <span id="entered_admin_username"></span> <br>
                                <strong>Mật khẩu:</strong> <span id="entered_admin_password"></span>
                            </p>
                        </div>
                    </section>
                    <!-- Step 4 -->
                    ...
                    <div style="display: none;">
                        <button class="btn btn-primary" name="submit" type="submit" id="wizard-submittion">Cài đặt</button>
                    </div>
                    <!-- Submit -->
                    <!-- Loader -->
                    <div id="loader" style="display: none;">
                        <div class="wizard-loader">
                            Đang cài đặt... Không được tắt trang...<span class="spinner-grow spinner-grow-sm ml-3"></span>
                        </div>
                    </div>
                    <!-- Loader -->
                </form>
